    ...
    <section class="divisi">
        <div class="container">
            <div class="text-center nama-divisi d-md-flex align-items-center justify-content-center mx-auto" data-aos="zoom-out">
                <div class="title-divisi">Presiden dan Wakil</div>
                <!-- <img src="assets/img/ppbjmo.png" alt="BJMO LOGO" class="img-fluid my-md-auto"> -->
            </div>
            <div class="row justify-content-between my-5">
                <div class="col-md-5">
                    <img src="assets/img/bph-bpi/yogi-risma.webp" alt="yogi-risma" class="img-fluid" data-aos="fade-up">
                    <div class="nama-area bg-primary text-center text-light py-4 shadow">
                        <span class="fw-bold">Attila Shandi Prayogi Zain</span><br>
                        Presiden BEM<br>
                        <br>
                        <span class="fw-bold">Risma Karimatul Mahmuda W</span><br>
                        Wakil Presiden BEM
                    </div>
                </div>
                        ...
                        <div class="accordion-item mb-5 border-0">
                            ...
                            <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingOne">
                                <div class="accordion-body shadow">
                                    Pengambilan kebijakan tertinggi serta bertanggung jawab akan segala kegiatan dan aktivitas BEM Fakultas Vokasi UB yang menjalankan fungsi kepemimpinan secara umum.
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item border-0">
                            ...
                            <div id="panelsStayOpen-collapseTwo" class="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingTwo">
                                <div class="accordion-body shadow bg-white">
                                    Mendampingi dan Membantu Presiden BEM dalam menjalankan tugasnya serta Menggantikan Fungsi dan Peran Presiden BEM jika berhalangan. Wakil Presiden BEM juga bertanggung jawab akan segala kegiatan dan aktivitas BEM Fakultas Vokasi UB bersama Presiden BEM.
                                </div>
                            </div>
                        </div>
                    </div>
